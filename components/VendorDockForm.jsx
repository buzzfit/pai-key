    ...
    <div className=\"fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4\">
      <form onSubmit={handleSubmit}
        ...
        <label className=\"block\">
          ...
          <select required value={agentType}
        ...
        <div className=\"grid gap-4 sm:grid-cols-2\">
          ...
          <label className=\"block\">
            <span>Tagline</span>
            <input required maxLength={80} value={tagline}
          ...
          <div className=\"mt-2 grid grid-cols-2 gap-2 text-sm\">
            {PROOF_OPTIONS.map(o => (
              <label key={o.value} className=\"flex items-center gap-2\">
                <input type=\"checkbox\" checked={proof.includes(o.value)}
        ...
        <div className=\"flex justify-end gap-2\">
          ...
          <button type=\"submit\" disabled={!xrpAddr}
                  className=\"rounded bg-matrix-green px-4 py-2\">Submit</button>
        </div>
      </form>
    </div>
  );
