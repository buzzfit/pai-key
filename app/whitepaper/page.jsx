...
export default function WhitepaperPage() {
  return (
    <article className="max-w-4xl mx-auto py-20 px-4 prose prose-lg dark:prose-invert">
      ...
      <ul>
        ...
        <li><strong>Phase 1</strong> (Q3 2025): Hooks amendment live → on‑chain wasm proof.</li>
