  ...
  return (
    <article className="max-w-4xl mx-auto py-20 px-4 prose prose-xl lg:prose-2xl dark:prose-invert">
      ...
      <table className="table-auto border-collapse border border-gray-300">
        <thead>
          <tr><th className="border border-gray-300 px-4 py-2 text-left">Threat</th><th className="border border-gray-300 px-4 py-2 text-left">Mitigation</th></tr>
        </thead>
        <tbody>
          <tr><td className="border border-gray-300 px-4 py-2">Agent exceeds scope</td><td className="border border-gray-300 px-4 py-2">XRPL enforces quorum 1 & spend limits (no own-key)</td></tr>
          <tr><td className="border border-gray-300 px-4 py-2">Human withholds funds</td><td className="border border-gray-300 px-4 py-2">EscrowFinish can be triggered by on-chain proof or oracle ruling</td></tr>
          <tr><td className="border border-gray-300 px-4 py-2">Fee starvation</td><td className="border border-gray-300 px-4 py-2">Client library auto-fills dynamic fee; user can bump > 10 drops</td></tr>
          <tr><td className="border border-gray-300 px-4 py-2">Key compromise</td><td className="border border-gray-300 px-4 py-2">Human rotates SignerList; emergency “freeze AI” script</td></tr>
        </tbody>
      </table>
